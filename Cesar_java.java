...
// Sei que é possível usar o Char e com isso trabalhar com Unicode
// porém seria fácil e preferir fazer assim
...
public class CifraCesar {
    ...
    /**
     * Passando o índice, sendo maior que lista ele começa a pegar do início e sendo
     * menor, começa a pegar do fim esse método impede de lançar uma
    ...
    private String pegar_letra(int indice) {
        ...
        // qualquer valor < 0, recebê 36, ou seja, -2+36=34
        // qualquer valor >= 36, retiro 36 ou seja, 38-36=2 / 36-36=0
        // valores entre 0 e 35 não cai no if
    ...
    /**
     * Esse método criptografa a msg Modo 0 = Criptografa Modo 1 = Descriptografia
     *
     * @param chave posição de n casas que vai para frente ou para trás
    ...
    private String criptografia(int chave, String msg, int modo) {
        ...
        for (int indice = 0; indice < mensagem.length(); indice++) {
            ...
            // Caso não esteja na lista, o indexOf retorna -1, com isso
